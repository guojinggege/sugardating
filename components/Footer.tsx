  ...
  return (
    <footer className="foot">
      <div className="container foot-in">
        <div>
          <div className="fbrand"><span className="gm"><Spark /></span>拾光</div>
          <p className="about">华语与亚裔创作者的发现与订阅平台。覆盖新加坡、香港、台北、吉隆坡、首尔、曼谷、伦敦、悉尼。</p>
        </div>
        <div><h5>浏览</h5><ul><li><Link href="/photography">摄影</Link></li><li><Link href="/video">视频</Link></li><li><Link href="/art-services">艺术服务</Link></li><li><Link href="/ai-artists">AI艺术家</Link></li></ul></div>
      ...
      <div className="container foot-b"><span>© 2026 拾光. 保留所有权利.</span><span>简体中文 · 繁體 · English</span></div>
    </footer>
  );
}
