  ...
  return (
    <footer className="foot">
      <div className="container foot-in">
        ...
        <div><h5>浏览</h5><ul><li><Link href="/photography">动态推荐</Link></li><li><Link href="/video">视频专区</Link></li><li><Link href="/art-services">专属服务</Link></li><li><Link href="/male-artists">SugarGirl</Link></li><li><Link href="/ai-artists">在线伴侣</Link></li></ul></div>
