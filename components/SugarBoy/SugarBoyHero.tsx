// Sugarboy 频道 Hero — 结构复用 SugarGirlHero,文案与主标题换成 Sugarboy
import Image from "next/image";
import Link from "next/link";

export default function SugarBoyHero({ bg }: { bg: string }) {
  return (
    <section className="relative isolate w-full overflow-hidden bg-black">
      ...
      <div className="relative z-10 mx-auto flex min-h-[54vh] max-w-[1100px] flex-col items-center justify-center px-5 py-20 text-center md:min-h-[64vh] md:px-8">
        ...
        <p className="mt-5 max-w-2xl text-[15px] leading-relaxed text-feed-ink/72 md:text-[17px]">
          高端男性 Creator · Companion · Lifestyle — 按城市、语言、在线状态和服务类型筛选,
          开启聊天、视频、预约或定制陪伴体验。
        </p>
        <p className="mt-2 max-w-2xl text-[12.5px] italic leading-relaxed text-feed-ink/50">
          Browse verified Sugarboys by city, language, availability, services and verification status.
        </p>
